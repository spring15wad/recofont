...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { font_stack: @recommendation.font_stack, pull_request_url: @recommendation.pull_request_url, recommendation: @recommendation.recommendation, team_id: @recommendation.team_id }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { font_stack: @recommendation.font_stack, pull_request_url: @recommendation.pull_request_url, recommendation: @recommendation.recommendation, team_id: @recommendation.team_id }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
