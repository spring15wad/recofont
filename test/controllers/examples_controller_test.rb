...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { file: @example.file, recommendation_id: @example.recommendation_id, url: @example.url }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { file: @example.file, recommendation_id: @example.recommendation_id, url: @example.url }
    assert_redirected_to example_path(assigns(:example))
  end
